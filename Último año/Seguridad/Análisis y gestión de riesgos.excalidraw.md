...
Identificación de objetivos ^b2RIy3Wq

Identificación de restricciones ^SXQLOvIp
...
IMPACTO = VALOR * DEGRADACIÓN * (1 - EficaciaRI)
RIESGO = IMPACTO * FRECUENCIA * (1 - EficaciaRF) ^cK2XcC8n
...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"boundElements": [
				{
					"id": "-KhAzIBFjRRFLZv36nKTF",
					"type": "arrow"
				},
				{
					"id": "UXTg6vwpPk5-o1H9GSfXg",
					"type": "arrow"
				}
			],
			"updated": 1695307667159,
		...
		},
		{
			...
			"rawText": "Identificación de objetivos",
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
			"originalText": "Identificación de objetivos"
		},
		{
			"type": "text",
			"version": 208,
			...
			"rawText": "Identificación de restricciones",
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
			"originalText": "Identificación de restricciones"
		},
		{
			"type": "text",
			"version": 199,
		...
		},
		{
			...
			"opacity": 100,
			"angle": 0,
			"x": -226.85013138351962,
			"y": 226.1933176671261,
			"strokeColor": "#000000",
			"backgroundColor": "transparent",
			"width": 79.43782043457031,
			"height": 42.91544828872995,
			"seed": 1933572507,
			"groupIds": [],
			"roundness": {
				"type": 2
		...
		},
		{
			"id": "cK2XcC8n",
			"type": "text",
			"x": -274.60315160991337,
			"y": 1698.3547694194644,
			"width": 555.459716796875,
			"height": 48,
			"angle": 0,
			"strokeColor": "#000000",
			"backgroundColor": "transparent",
			...
			"seed": 239517397,
			"version": 151,
			"versionNonce": 1088056443,
			"isDeleted": false,
			"boundElements": null,
			"updated": 1695308757484,
			"link": null,
			"locked": false,
			"text": "IMPACTO = VALOR * DEGRADACIÓN * (1 - EficaciaRI)\nRIESGO = IMPACTO * FRECUENCIA * (1 - EficaciaRF)",
			"rawText": "IMPACTO = VALOR * DEGRADACIÓN * (1 - EficaciaRI)\nRIESGO = IMPACTO * FRECUENCIA * (1 - EficaciaRF)",
			"fontSize": 20,
			"fontFamily": 1,
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
			"originalText": "IMPACTO = VALOR * DEGRADACIÓN * (1 - EficaciaRI)\nRIESGO = IMPACTO * FRECUENCIA * (1 - EficaciaRF)"
		}
	],
	"appState": {
		"theme": "light",
		...
		"scrollX": 369.25753050691276,
		"scrollY": -1468.696316173493,
		"zoom": {
			"value": 1.7220545092517352
		},
