...
Nivel 3: Usando biblioteca de cliente para esa API concreta ^O3yWZGNv
...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"seed": 510300202,
			"version": 76,
			"versionNonce": 1500159414,
			"isDeleted": false,
			"boundElements": null,
			"updated": 1696588109548,
			"link": null,
			"locked": false,
			"text": "Nivel 3: Usando biblioteca de cliente para esa API concreta",
			"rawText": "Nivel 3: Usando biblioteca de cliente para esa API concreta",
			"fontSize": 20,
			"fontFamily": 1,
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
			"originalText": "Nivel 3: Usando biblioteca de cliente para esa API concreta"
		}
	],
	"appState": {
		"theme": "light",
